...
The [**GAMBIT_Query_PHB**](https://theiagen.github.io/public_health_bioinformatics/latest/workflows/standalone/gambit_query/) workflow performs taxon assignment of a genome assembly using GAMBIT. It can be imported directly to [Terra.bio](https://terra.bio) via [Dockstore](https://dockstore.org).
...
!!! tip inline end "Import workflows to [Terra.bio](https://terra.bio/):"
    ...
    [**TheiaEuk Workflow Series**](https://theiagen.github.io/public_health_bioinformatics/latest/workflows/genomic_characterization/theiaeuk/)
      ...
      - [TheiaEuk_ONT_PHB](https://dockstore.org/workflows/github.com/theiagen/public_health_bioinformatics/TheiaEuk_ONT_PHB)

Additionally, GAMBIT is also part of the [**TheiaProk**](https://theiagen.github.io/public_health_bioinformatics/latest/workflows/genomic_characterization/theiaprok/) and [**TheiaEuk**](https://theiagen.github.io/public_health_bioinformatics/latest/workflows/genomic_characterization/theiaeuk/) collection of workflows, the first dedicated to the analysis of prokaryotic data, and the second to the analysis of mycotic data. The TheiaProk or TheiaEuk most appropriate for your type of input data can be imported from the Dockstore links on the right.
